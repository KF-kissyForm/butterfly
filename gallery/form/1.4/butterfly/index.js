 ...
 **/
KISSY.add('gallery/form/1.4/butterfly/index', function (S, Base, Node, Event, Collection, RenderRadio, RenderCheckbox, RenderLimiter, RenderImageUploader, RenderNumber, RenderSelect,RenderEditor, Auth) {
        var EMPTY = '';
        var $ = Node.all;
        var LOG_PREFIX = '[Butterfly]:';
        var CSS_URL_PRE = 'gallery/form/1.4/butterfly/themes/';
