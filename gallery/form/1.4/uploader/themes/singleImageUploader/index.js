 ...
 * @author 苏河、紫英、明河
 **/
KISSY.add('gallery/form/1.4/uploader/themes/singleImageUploader/index',function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
    ...
    S.extend(singleImageUploader, Theme, /** @lends singleImageUploader.prototype*/{
         ...
         * css模块路径
         * @type String
         * @default "gallery/form/1.4/uploader/themes/imageUploader/style.css"
         */
        cssUrl:{value:'gallery/form/1.4/uploader/themes/singleImageUploader/style.css'},
        /**
         * 队列使用的模板
         * @type String
         * @default ""
