 ...
 * @author 苏河、紫英、明河
 **/
KISSY.add('gallery/form/1.4/uploader/themes/loveUploader/index', function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
    ...
    S.extend(ImageUploader, Theme, /** @lends ImageUploader.prototype*/{
         ...
         * css模块路径
         * @type String
         * @default "gallery/form/1.4/uploader/themes/loveUploader/style.css"
         */
        cssUrl:{value:'gallery/form/1.4/uploader/themes/loveUploader/style.css'},
        /**
         * 队列使用的模板
         * @type String
         * @default ""
