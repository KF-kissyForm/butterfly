 ...
 **/
KISSY.add('gallery/form/1.4/uploader/themes/daogouUploader/index', function (S, Node, Theme) {
    var EMPTY = '', $ = Node.all;
    ...
    S.extend(Daogou, Theme, /** @lends Daogou.prototype*/{
       ...
       _waitingHandler:function(ev){
         ...
         */
        cssUrl:{value:'gallery/form/1.4/uploader/themes/daogouUploader/style.css'},
        /**
         * 队列使用的模板
         * @type String
         * @default ""
