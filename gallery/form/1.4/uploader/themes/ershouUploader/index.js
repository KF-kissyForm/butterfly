 ...
 **/
KISSY.add('gallery/form/1.4/uploader/themes/ershouUploader/index', function (S, Node, Theme, Message, SetMainPic) {
    var EMPTY = '', 
    	$ = Node.all,
    ...
    S.extend(ErshouUploader, Theme, /** @lends ErshouUploader.prototype*/ {
    	...
    	ATTRS: /** @lends ErshouUploader.prototype*/ {
	         ...
	         * css模块路径
	         * @type String
	         * @default "gallery/form/1.4/uploader/themes/ershouUploader/style.css"
	         */
	        cssUrl: { 
	        	value: 'gallery/form/1.4/uploader/themes/ershouUploader/style.css'
			},
	        /**
	         * 队列使用的模板
	         * @type String
