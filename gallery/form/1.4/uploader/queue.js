 ...
 **/
KISSY.add('gallery/form/1.4/uploader/queue', function (S, Node, Base) {
     ...
     * @example
     * S.use('gallery/form/1.4/uploader/queue/base,gallery/form/1.4/uploader/themes/default/style.css', function (S, Queue) {
     *    var queue = new Queue();
     *    queue.render();
     * })
     */
