 ...
 **/
KISSY.add('gallery/form/1.4/uploader/index', function (S, Node, UploaderBase) {
     ...
     */
    function Uploader(target, config) {
        var self = this;
        //调用父类构造函数
    ...
    S.extend(Uploader, UploaderBase, /** @lends Uploader.prototype*/{
        /**
