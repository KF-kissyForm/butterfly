 ...
 **/
KISSY.add('gallery/form/1.4/uploader/button/swfButton', function (S, Node, Base, SwfUploader) {
    var EMPTY = '', $ = Node.all,
    ...
    S.extend(SwfButton, Base, /** @lends SwfButton.prototype*/{
         ...
         * @type Object
         * @default { src:'http://a.tbcdn.cn/s/kissy/gallery/form/1.4/uploader/plugins/ajbridge/uploader.swf', id:'swfUploader', params:{ bgcolor:"#fff", wmode:"transparent" }, attrs:{ }, hand:true, btn:true }
             }
         */
        flash:{
            value:{
                src:'http://a.tbcdn.cn/s/kissy/gallery/form/1.4/uploader/plugins/ajbridge/uploader.swf',
                id:'swfUploader',
                params:{
                    bgcolor:"#fff",
                    wmode:"transparent"
