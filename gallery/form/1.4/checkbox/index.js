 ...
 *
 **/
KISSY.add('gallery/form/1.4/checkbox/index', function(S, Base, Node, Radio) {
    var $ = Node.all;
    /**
     * @name Checkbox
    ...
    S.extend(Checkbox, Base, /** @lends Checkbox.prototype*/ {
        ...
        ATTRS: /** @lends Checkbox.prototype*/
        {
             ...
             */
            cssUrl: {
                value: 'gallery/form/1.4/checkbox/themes/default/style.css'
            },
            /**
             * 是否需要label for的对应
             * @default false
    ...
    requires: ['base', 'node', 'gallery/form/1.4/radio/index']
});